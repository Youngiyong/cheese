...
public class AdminDetailsServiceImpl implements UserDetailsService {
    ...
    public BaseResponse save(SignupRequest payload) throws UsernameNotFoundException {
        ...
        if (strRoles == null){
            AdminRole userRole = adminRoleRepository.findByName(EAdminRole.ROLE_ADMIN).get();
            ...
            for (String role: strRoles){
                switch (role) {
                    case "ADMIN":
                        ...
                        break;
                    case "MANAGER":
                        AdminRole managerRole = adminRoleRepository.findByName(EAdminRole.ROLE_MANAGER).get();
                        ...
                        break;
                    default:
                        AdminRole userRole = adminRoleRepository.findByName(EAdminRole.ROLE_USER).get();
